...
class SearchActivity : AppCompatActivity() {
    ...
    private fun loadProducts() {
        // Simulasi data produk dengan gambar (mock)
        allProducts.addAll(
            listOf(
                ...
                Product("p9", "Air Mineral 600ml", 3000, imageResId = R.drawable.airmineral, description = "Air mineral kemasan botol"),
                Product("p10", "Biskuit Coklat", 15000, imageResId = R.drawable.biskuit_coklat, description = "Biskuit dengan coklat premium"),
                Product("p11", "Sosis Ayam", 25000, imageResId = R.drawable.sosisayam, description = "Sosis ayam berkualitas"),
                Product("p12", "Keju Cheddar", 35000, imageResId = R.drawable.keju, description = "Keju cheddar asli"),
                Product("p13", "Yogurt Strawberry", 12000, imageResId = R.drawable.yogurtstrawberry, description = "Yogurt rasa strawberry"),
                Product("p14", "Cereal Sarapan", 28000, imageResId = R.drawable.cereal, description = "Cereal untuk sarapan sehat"),
                Product("p15", "Jus Jeruk", 8000, imageResId = R.drawable.jusjeruk, description = "Jus jeruk segar"),
                Product("p16", "Kerupuk Udang", 18000, imageResId = R.drawable.kerupuk_udang, description = "Kerupuk udang renyah")
            )
        )
